...
const PropertyGallery: React.FC<PropertyGalleryProps> = ({ images, onClose, propertyName }) => {
    ...
    <div className="fixed inset-0 bg-black z-50 overflow-y-auto">
      <div className="relative">
        ...
        <div className="gallery max-w-7xl mx-auto px-4 py-20">
          <h1 className="text-3xl font-bold text-white mb-8">{propertyName} Gallery</h1>
